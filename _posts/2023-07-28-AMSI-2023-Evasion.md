...
tags:
  ...
  - memory-patching
  - obfuscation
excerpt: "Bypassing Windows 10 AMSI by patching AmsiScanBuffer in memory and obfuscating the PowerShell payload to land an in-memory reverse shell."
---
